...
<body>
    ...
    <script>
        ...
        btn_simpan.addEventListener('click',function(){
            ...
            let txt_status_perkawinan = document.getElementById("txt_status_perkawinan");
            ...
            && ttl[1] === "" && status_perkawinan[1] === ""&& alamat[1] === ""   )
            {
                ...
                setSave(txt_rm.value,txt_nik.value,txt_nama.value,cbo_kelamin.value,txt_telepon.value,
                txt_ttl.value,cbo_status_perkawinan.value,txt_alamat.value);
            }            
        });

        const setSave = (rm,nik,nama,kelamin,telepon,ttl,status_perkawinan,alamat)  => {
